...
//--add-modules=java.se.ee --permit-illegal-access  --patch-module java.xml.ws.annotation=./myannotation.jar --add-modules=java.se.ee --permit-illegal-access  --patch-module java.xml.ws.annotation=./myannotation.jar
...
public final class StreamingServer {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        staticContext.setResourceBase(
        		StreamingServer.class.getResource("/web-ui")
        		.toURI()
        		.toString());
